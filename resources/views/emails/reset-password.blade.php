...
@section('body')
  ...
  <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-bottom:24px;">
    <tr>
      ...
      <td style="vertical-align:middle;padding-left:14px;">
        ...
        <p style="margin:0;font-size:13px;color:#6b7280;">Verzoek ontvangen voor uw account</p>
      </td>
    </tr>
  </table>
  ...
  <p style="margin:0 0 24px;font-size:14px;line-height:1.7;color:#374151;">
    We hebben een verzoek ontvangen om uw wachtwoord te resetten. Klik op de knop hieronder om een nieuw wachtwoord in te stellen. De link is <strong style="color:#111827;">60 minuten</strong> geldig.
  </p>
