...
@section('body')
  ...
  <p style="margin:0 0 16px;font-size:10px;font-weight:700;letter-spacing:0.1em;text-transform:uppercase;color:#7e8a9c;">
    {{ __('mail.route_planning.how_label') }}
  </p>
  ...
  <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-bottom:14px;">
    <tr>
      ...
      <td style="vertical-align:top;padding-left:14px;">
        <p style="margin:0 0 3px;font-size:14px;font-weight:700;color:#f8fafc;">{{ __('mail.route_planning.step_1_title') }}</p>
        <p style="margin:0;font-size:13px;line-height:1.6;color:#94a3b8;">
          {{ __('mail.route_planning.step_1_body') }}
        </p>
      </td>
    </tr>
  </table>
  ...
  <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-bottom:14px;">
    <tr>
      ...
      <td style="vertical-align:top;padding-left:14px;">
        <p style="margin:0 0 3px;font-size:14px;font-weight:700;color:#f8fafc;">{{ __('mail.route_planning.step_2_title') }}</p>
        <p style="margin:0;font-size:13px;line-height:1.6;color:#94a3b8;">
          {{ __('mail.route_planning.step_2_body') }}
        </p>
      </td>
    </tr>
  </table>
  ...
  <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-bottom:24px;">
    <tr>
      ...
      <td style="vertical-align:top;padding-left:14px;">
        <p style="margin:0 0 3px;font-size:14px;font-weight:700;color:#f8fafc;">{{ __('mail.route_planning.step_3_title') }}</p>
        <p style="margin:0;font-size:13px;line-height:1.6;color:#94a3b8;">
          {{ __('mail.route_planning.step_3_body') }}
        </p>
      </td>
    </tr>
  </table>
  ...
  <div style="background:#0d1320;border:1px solid #1e293b;border-radius:10px;padding:14px 16px;margin:0 0 26px;">
    <p style="margin:0 0 10px;font-size:10px;font-weight:700;letter-spacing:0.1em;text-transform:uppercase;color:#7e8a9c;">
      {{ __('mail.route_planning.all_in_one') }}
    </p>
    @php
      $features = array_map(fn ($i) => __("mail.route_planning.feature_{$i}"), range(1, 7));
    @endphp
