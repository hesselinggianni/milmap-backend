...
@section('body')
  ...
  <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-bottom:24px;">
    <tr>
      <td style="vertical-align:top;width:56px;">
        <div style="width:48px;height:48px;background:#ecfdf3;border:1px solid #bbf7d0;
      ...
      <td style="vertical-align:middle;padding-left:14px;">
        ...
        <p style="margin:0;font-size:13px;color:#6b7280;">{{ $inviterName }} wil met je chatten</p>
      </td>
    </tr>
  </table>
  ...
  <p style="margin:0 0 24px;font-size:14px;line-height:1.7;color:#374151;">
    <strong style="color:#111827;">{{ $inviterName }}</strong> heeft je uitgenodigd om te chatten op het
