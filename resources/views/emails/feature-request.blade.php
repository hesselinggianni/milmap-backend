...
@section('title', __('mail.feature_request.page_title'))
@section('body')
    ...
    <tr>
      ...
      <td style="vertical-align:middle;padding-left:14px;">
        <h1 style="margin:0 0 3px;font-size:20px;font-weight:700;color:#f8fafc;letter-spacing:-0.01em;line-height:1.2;">
          {{ __('mail.feature_request.title') }}
        </h1>
        <p style="margin:0;font-size:13px;color:#94a3b8;">{{ __('mail.feature_request.subtitle') }}</p>
      </td>
    </tr>
  </table>
  ...
  <p style="margin:0 0 6px;font-size:10px;font-weight:700;letter-spacing:0.1em;text-transform:uppercase;color:#7e8a9c;">
    {{ __('mail.feature_request.feature') }}
  </p>
  ...
  <!-- Gebruiker -->
  <p style="margin:0 0 6px;font-size:10px;font-weight:700;letter-spacing:0.1em;text-transform:uppercase;color:#7e8a9c;">
    {{ __('mail.feature_request.submitted_by') }}
  </p>
  ...
  <!-- Beschrijving -->
  <p style="margin:0 0 6px;font-size:10px;font-weight:700;letter-spacing:0.1em;text-transform:uppercase;color:#7e8a9c;">
    {{ __('mail.feature_request.description') }}
  </p>
  ...
  <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0"
    ...
    <tr>
      <td colspan="2"
        ...
        {{ __('mail.feature_request.details_title') }}
      </td>
    </tr>
    <tr>
      <td style="padding:11px 16px;width:30%;font-size:12.5px;color:#94a3b8;border-bottom:1px solid #1a2433;font-weight:500;">
        {{ __('mail.feature_request.priority') }}
      </td>
      <td style="padding:11px 16px;font-size:13px;border-bottom:1px solid #1a2433;">
        @if($data['priority'] === 'high')
          <span style="color:#dc2626;font-weight:600;">{{ __('mail.feature_request.priority_high') }}</span>
        @elseif($data['priority'] === 'medium')
          <span style="color:#2b7fff;font-weight:600;">{{ __('mail.feature_request.priority_medium') }}</span>
        @else
          <span style="color:#94a3b8;font-weight:600;">{{ __('mail.feature_request.priority_low') }}</span>
        @endif
      </td>
    </tr>
    <tr>
      <td style="padding:11px 16px;font-size:12.5px;color:#94a3b8;font-weight:500;">
        {{ __('mail.feature_request.time') }}
      </td>
