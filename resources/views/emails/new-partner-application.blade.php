...
@section('body')
  ...
  <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0"
    ...
    <tr><td style="padding:16px 18px;">
      ...
      <p style="margin:0 0 6px;font-size:13px;color:#94a3b8;">{{ __('mail.new_partner_application.email_label') }}</p>
      <p style="margin:0 0 14px;font-size:14px;color:#f8fafc;">{{ $partner->user->email }}</p>
      @if($partner->website)
      <p style="margin:0 0 6px;font-size:13px;color:#94a3b8;">{{ __('mail.new_partner_application.website_label') }}</p>
      <p style="margin:0 0 14px;font-size:14px;color:#f8fafc;">{{ $partner->website }}</p>
      @endif
      <p style="margin:0 0 6px;font-size:13px;color:#94a3b8;">{{ __('mail.new_partner_application.motivation_label') }}</p>
    ...
    <tr>
      <td style="border-radius:10px;background:#2b7fff;">
        <a href="https://admin.milmap.nl/partners"
          ...
          {{ __('mail.new_partner_application.cta') }}
        </a>
      </td>
    </tr>
  </table>
