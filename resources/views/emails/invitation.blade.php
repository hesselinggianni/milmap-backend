...
@section('body')
  ...
  <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-bottom:24px;">
    <tr>
      ...
      <td style="vertical-align:middle;padding-left:14px;">
        ...
        <p style="margin:0;font-size:13px;color:#6b7280;">{{ $inviterName }} nodigt je uit om samen te werken</p>
      </td>
    </tr>
  </table>
  ...
  <p style="margin:0 0 24px;font-size:14px;line-height:1.7;color:#374151;">
    <strong style="color:#111827;">{{ $inviterName }}</strong> heeft je uitgenodigd om deel te nemen aan de
    {{ $resourceLabel }} <strong style="color:#111827;">{{ $resourceTitle }}</strong> op MilMap.
  ...
  @if($isNewUser)
    <p style="margin:0 0 20px;padding:12px 16px;background:#eff6ff;border:1px solid #c3d8ff;border-radius:8px;
